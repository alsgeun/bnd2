...
export class UserService {
    ...
    // 회원가입 api
    signUp = async (email, password, name, age, gender, character, profileImage) => {
        ...
        const userInfo = await this.userRepository.createUserInfo(user.userId, name, age, gender, character, profileImage)  
